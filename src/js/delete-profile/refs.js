const refs = {
  delProfileModalWin: document.querySelector('.js-delete-profile-modal-win'),
  delProfileModalWinBtn: document.querySelector('.js-delete-profile-modal-win-btn'),
  delProfileBtn: document.querySelector('.js-delete-profile-btn'),
